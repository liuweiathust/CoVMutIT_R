...
DocumentsTab <- tabItem(
			  tabName = "documents",
			    fluidPage(
				            mainPanel(
							                h2(strong("Material and methods")),
									            h3(strong("The CoVMutIT framework")),
									            h4(p("The CoVMutIT framework outlines three defining principles:"),
